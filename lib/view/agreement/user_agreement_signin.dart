...
class UserAgreementSignin extends StatefulWidget {
  var index;

  UserAgreementSignin({super.key, required this.index});

  @override
  State<UserAgreementSignin> createState() => _UserAgreementSigninState();
}

class _UserAgreementSigninState extends State<UserAgreementSignin> {
  bool? check = false;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xffF0F3F8),
      body: Consumer2<SignUpViewModel,ProfileViewModel>(builder: (context, signupViewModel,profileViewModel, _) {
        return SafeArea(
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            if (await profileViewModel.validateData(
                                    index: widget.index) &&
                                check!) {
                              await profileViewModel.patchProfileData(profileViewModel.profileBody);
                              // showDialog(
                              //   context: context,
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) =>
                                    _buildPopupDialog(context,
                                        'Error while trying to login. Please fill your data correctly'),
                              );
                            }
                          },
