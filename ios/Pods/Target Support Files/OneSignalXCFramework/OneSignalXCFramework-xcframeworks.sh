...
install_xcframework "${PODS_ROOT}/OneSignalXCFramework/iOS_SDK/OneSignalSDK/OneSignal_LiveActivities/OneSignalLiveActivities.xcframework" "OneSignalXCFramework/OneSignalLiveActivities" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
