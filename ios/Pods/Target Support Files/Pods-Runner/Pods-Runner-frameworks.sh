...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_compass/flutter_compass.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ml_card_scanner/ml_card_scanner.framework"
